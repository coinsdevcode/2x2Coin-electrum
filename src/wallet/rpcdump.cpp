...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"2x2coinaddress\"\n"
            "\nReveals the private key corresponding to '2x2coinaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"2x2coinaddress\"   (string, required) The 2x2coin address for the private key\n"
            "\nResult:\n"
