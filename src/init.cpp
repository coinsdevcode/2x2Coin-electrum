...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/2x2Coin/2x2Coin>";
    const std::string URL_WEBSITE = "<https://2x2coin.com//>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The 2x2Coin Developers", 2025)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find 2x2Coin useful. "
