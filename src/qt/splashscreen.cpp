    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightText2x2Coin   = QChar(0xA9)+QString(" %1 ").arg(2025) + QString("Quimera Labs Developers");
    ...
    QSize splashSize(650*devicePixelRatio,340*devicePixelRatio);
    ...
    QRect rectIcon(QPoint(-40,-110), QSize(450,450));
    ...
    // draw copyright stuff
    {
        ...
        pixPaint.drawText(x,y+30,copyrightText2x2Coin);
    }
