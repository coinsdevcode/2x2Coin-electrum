...
const QString BITCOIN_IPC_PREFIX("2x2coin:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/2x2coin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/2x2coin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/2x2coin-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click 2x2coin: links
...
//
// OSX-specific way of handling 2x2coin: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in 2x2coin: URIs
